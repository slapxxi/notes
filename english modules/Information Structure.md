**Information structure** in English refers to how information in a sentence is organized, specifically how different elements like new and old information, focus, and emphasis are presented. This organization affects the meaning and flow of sentences, helping speakers convey their message clearly and efficiently. Here's a breakdown of key aspects of information structure in English:

### 1. **Given vs. New Information**

- **Given information** is what the listener already knows or can infer from context.
- **New information** is what the speaker introduces or expects the listener to learn.

In English, **new information** typically appears toward the end of the sentence, while **given information** appears at the beginning. This order helps the listener understand the relationship between known and unknown elements.
...
**Focus** refers to the part of the sentence that carries the most important information or the information the speaker wants to emphasize. In English, focus typically falls on the **last element** of the sentence, or it can be marked with special stress, intonation, or word order.
...
A **cleft sentence** is a structure used to focus attention on a particular part of the sentence. It is often used to highlight new or important information.
...
**Topicalization** involves moving a specific element to the front of the sentence to emphasize it as the topic of the conversation.
...
In English, **word order** plays a crucial role in information structure. The typical word order in declarative sentences is **Subject-Verb-Object** (SVO). However, elements can be rearranged to focus on specific parts of the sentence.
...
When there is a need to highlight **contrast**, speakers use **contrastive stress** to emphasize the differences between ideas or entities.
